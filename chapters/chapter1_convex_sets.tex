...
\end{definition}
A non convex cone can be hyper-plane~\cite{aliPowderBedFusion2022}.\\
...
\end{example}
For a convex set $x \in C \Rightarrow x = \sum \alpha_i x_i$~\cite{aminComputationalHomogenizationElastic2018}. 
...
\end{definition}
Interpretation: There is a convex quadratic $\frac{1}{2}u || \cdot ||^2$ that lower bounds f~\cite{aminiMLCPMProcessMonitoring2018}.
\begin{example}
