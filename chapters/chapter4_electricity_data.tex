...
Les méthodes de calage ont été formalisées par Deville et Särndal (1992)~\cite{alrifaieCompressionBehaviorThreedimensional2019}. Ils donnent un cadre général pour l'estimation par calage et étudient les propriétés de ces estimateurs. L'information auxiliaire utilisée est un vecteur de totaux connus $t_{x}$.
...
Ce travail visait à développer plusieurs plans permettant d’estimer la consommation totale d'électricité~\cite{abdulhadiDevelopingScalingLaws2023}. Introduire des méthodes issues de la théorie des sondages, nous a permis de comprendre les principes et les enjeux de cette discipline.
