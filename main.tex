...
\newcommand{\chapterwithbibliography}[1]{%
  \begin{refsection}%
    \input{#1}%
    \printbibliography[heading=subbibliography,title={Chapter \thechapter Bibliography}]%
  \end{refsection}%
}

\chapterwithbibliography{chapters/chapter1_convex_sets}
\chapterwithbibliography{chapters/chapter2_dummy_chapter}
\chapterwithbibliography{chapters/chapter3_dummy_chapter}
\chapterwithbibliography{chapters/chapter4_electricity_data}
